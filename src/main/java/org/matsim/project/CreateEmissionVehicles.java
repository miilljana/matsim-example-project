...
//        busType.setDescription("BEGIN_EMISSIONSPASSENGER_CAR;average;average;averageEND_EMISSIONS");
    ...
    public static void main(String[] args) {
        ...
        for (int i = 50; i < 120; i++) {
            ...
            Path input_vehicles = Paths.get("../../..","scenarios","bilbao","output","output_"+id+"_"+h+"_"+d,"output_allVehicles.xml.gz");
            Path output_vehicles = Paths.get("../../..","scenarios","bilbao","output","output_"+id+"_"+h+"_"+d,"emission_vehicles.xml.gz");
