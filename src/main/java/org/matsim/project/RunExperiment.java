...
//            System.out.println("output_"+id+"_"+h+"_"+d);
...
//                    createnetworkChangeEventOpen(h*60*60+d*60*60, city_parts_comb.get(id), sc);
        ...
        createNetworkChangeEventClose(12 * 60 * 60, city_parts_comb.get("1"), sc);
        createnetworkChangeEventOpen(12 * 60 * 60 + 2 * 60 * 60, city_parts_comb.get("1"), sc);
...
//
////                    controler.getConfig().controler().setOutputDirectory(Paths.get("D:", "Users", "miljana", "experiment3","output_"+id+"_"+h+"_"+d).toString());
//                    controler.getConfig().controler().setOutputDirectory(Paths.get("D:", "Users", "miljana", "experiment3","output_test").toString());
//                    controler.run();


//            }

       ArrayList<String> proba = city_parts_comb.get("148");
