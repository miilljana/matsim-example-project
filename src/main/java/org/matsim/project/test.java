...
public class test {
    public static void main(String[] args) {
        ...
        //for coco server
        String path = Paths.get("D:","Users","miljana","experiment3").toString();

        for(int i =0;i<50;i++){
            System.out.println("city part"+ city_parts.get(a[i][0]-1)+" start hour:"+start_hour.get(a[i][1]-1)+" duration:"+duration.get(a[i][2]-1));
            }
        }
    }
