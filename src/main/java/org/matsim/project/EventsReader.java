...
//            }
//        }
        Path results = Paths.get("../../../", "scenarios", "bilbao", "output", "output_base","emissionEvents.xml");
        EventsManager events = new EventsManagerImpl();
        ArrayList<Double> emissions = readEmissions(events, results, linksMoyua, linksSurrounding);

        fw.write("sim_base" + "," + emissions.get(0) + "," + emissions.get(1) + "," + emissions.get(2) + ","+emissions.get(3) + "," + emissions.get(4) + "," + emissions.get(5) + "," + emissions.get(6) + "," + emissions.get(7) + "," + emissions.get(8) + "\n");
        System.out.println("reading simulation num: base"  + " done!");
        fw.close();
    }
}
