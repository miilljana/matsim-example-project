...
//        getTravelTime(linksMoyua,linksSurrounding,path1, path2,resuls);
        ...
        for (int i = 0; i < 50; i++) {
            ...
            Path path1 = Paths.get("D:", "Users", "miljana", "simulation", "output_"+id+"_"+h+"_"+d,"ITERS","it.200","200.linkstats.txt.gz");
            Path path2 = Paths.get("D:", "Users", "miljana", "simulation", "output_"+id+"_"+h+"_"+d,"ITERS","it.200","200.linkstats.txt");
